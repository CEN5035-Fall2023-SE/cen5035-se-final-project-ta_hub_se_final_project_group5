    ...
    <Card
      ...
      cover={
        ...
        style={{ height: '199px', objectFit: 'cover' }}
          alt="Profile"
          src="https://static.thenounproject.com/png/2724427-200.png"></img>
      }   
    >
      ...
      <Input value={name} style={{ border: 'none', background: 'transparent'}} readOnly />
        ...
        <Form.Item label="Email">
          <Input value={email} style={{ border: 'none', background: 'transparent'}} readOnly /> {/* Use the 'email' value from Redux */}
        </Form.Item>
