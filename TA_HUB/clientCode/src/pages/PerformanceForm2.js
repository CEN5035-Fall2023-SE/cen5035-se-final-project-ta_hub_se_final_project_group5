    ...
    if (selectedCandidate) {
      axios
        ...
        .then((response) => {
          ...
          console.log(data);
          console.log(studentInteraction);
        })
        .catch((error) => {
      ...
      {selectedCandidate && (
        <Row gutter={16} style={{ marginTop: '20px' }}>
          ...
          <Col span={4}>
            ...
            <p style={{ color: 'black' }}>{teachingEffectiveness}</p>
          </Col>
          <Col span={4}>
            <Title level={5}>Student Interaction:</Title>
            <p style={{ color: 'black' }}>{studentInteraction}</p>
          </Col>
          <Col span={4}>
          ...
          <Col span={4}>
            <Title level={5}>Preparation and Organization:</Title>
             <p style={{ color: 'black' }}>{preparationAndOrganization}</p>
          </Col>
          <Col span={4}>
            <Title level={5}>Professionalism and Collaboration:</Title>
            <p style={{ color: 'black' }}>{professionalismAndCollaboration}</p>
          </Col>
          <Col span={4}>
            <Title level={5}>Adaptability:</Title>
            <p style={{ color: 'black' }}>{adaptability}</p>
          </Col>
          <Col span={4}>
            <Title level={5}>Knowledge and Expertise:</Title>
            <p style={{ color: 'black' }}>{knowledgeAndExpertise}</p>
          </Col>
        </Row>
      )}
    </div>
...
export default PerformanceFormTAC;
